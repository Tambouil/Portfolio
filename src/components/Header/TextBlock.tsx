const TextBlock = () => {
  return (
    <div className="mt-8 lg:mt-0 lg:w-1/2">
      ...
      <p className="text-lg font-semibold text-center text-gray-600 sm:text-left">
        A fullstack web developer from West of France.
      </p>
      <p className="text-lg font-semibold text-center text-gray-600 sm:text-left">
        I build things for the web.
      </p>
      <div className="flex items-center mt-3 -mx-2 max-w-md xs:justify-center">
        <a href="/" className="mx-2" aria-label="Twitter">
          <svg
            className="w-6 h-6 text-gray-700 fill-current dark:text-gray-200 hover:text-cyan-500 "
        ...
        <a href="/" className="mx-2" aria-label="Email">
          <svg
            className="w-7 h-7 text-gray-700 fill-current dark:text-gray-200 hover:text-mrcorail"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
          >
        ...
        <a href="/" className="mx-2" aria-label="Linkedin">
          <svg
            className="w-6 h-6 text-gray-700 fill-current dark:text-gray-200 hover:text-mrcorail"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
          >
