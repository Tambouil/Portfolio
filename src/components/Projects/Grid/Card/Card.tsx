...
const Card = (props: IPost) => {
  return (
    <li className="flex flex-col justify-between col-span-1 rounded-lg shadow">
      <div className="flex items-center justify-between w-full p-6 space-x-6 overflow-hidden">
        <div className="flex-1">
          <div className="flex items-center space-x-3">
            ...
            <span className="flex-shrink-0 inline-block px-2 py-0.5 text-white text-xs leading-4 font-medium bg-blue-300 bg-opacity-70 rounded-full">
              {props.stack}
            </span>
          </div>
          <p className="mt-1 text-sm  text-gray-500">
            {props.description}
            <br />
            <span className="text-blue-400 font-light italic pt-2 inline-block">
              {props.build}
            </span>
          </p>
        </div>
      ...
      <div className="border-t border-gray-200">
        <div className="flex -mt-px">
          <div className="flex flex-1 w-0 border-r border-gray-200 hover:text-mrcorail">
            <a
              href={props.github}
              target="_blank"
              className={`relative inline-flex items-center justify-center flex-1 w-0 py-4 -mr-px text-sm font-medium leading-5  ${
                props.github === undefined ? "text-gray-200" : "text-gray-700"
          ...
          <div className="flex flex-1 w-0 -ml-px">
            <a
              ...
              className={`relative inline-flex items-center justify-center flex-1 w-0 py-4 text-sm font-medium leading-5 ${
                props.website === undefined ? "text-gray-200" : "text-gray-700"
